...
<html>
<meta name="google-site-verification" content="E-u-AVqn0BBznO-iEVO9d137w6vA-Ugd95TeWUFHvqE" />
<head>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-159384389-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-159384389-1');
</script><meta name="google-site-verification" content="E-u-AVqn0BBznO-iEVO9d137w6vA-Ugd95TeWUFHvqE" />
...
<script type="text/javascript" src="js/071504.js?1583018367" charset="utf-8"></script>
<link rel="stylesheet" type="text/css" href="css/comm/font/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="css/comm/animate.min.css"/>
<link rel="stylesheet" type="text/css" href="css/comm/box.css"/>
<link rel="stylesheet" type="text/css" href="css/comm/alert.css"/>
<link rel="stylesheet" type="text/css" href="css/071504.css?1583018367"/>
<script>
	var batchArr = [];
...
<a href='index.php' target="_self"><img class="imgSet"  src="img/comm/img_load.gif" data-original="img/logo.png?1583018367" title="我的世界仙魔录" alt="我的世界仙魔录" style="width:auto; height:100%; position:relative; top:0; left:50%; transform:translate(-50%,0);"/></a>
</div>				</div>
			</div>
  ...
  $(function () {
    ...
    $(jplayer_id).videoPlayer();
				...
				<div names="text" class="view_contents" >
					...
					<div id="text_style_01_1583018345148" class="view style_01 text  lockHeightView"  data-wow-duration='0s' data-wow-delay='0s' data-wow-offset='0' data-wow-iteration='1'>
				<div names="text" class="view_contents" >
					在线人数
				</div>
			</div>
...
<div class="roundcs modSet" ></div>
		...
		<div class="bottomMenu 123"><ul><li style="height:100%;padding-top:2px;">
							<a href="index.php" class="" style=""><div class="menuItem"><div class="menuIco"><img  src="img/comm/img_load.gif" data-original="img/upimages/pkgimg/icon/icon8.png" alt=""></div><input type="hidden" class="menuIcon" value="" ><input type="hidden" class="menuColor" value="#ee1c25" ><div class="menuName" style="color:#999999;">首页</div></div></a>
